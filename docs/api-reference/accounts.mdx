...
See [Errors](../getting-started/errors) for the standard error envelope.
...
Closure is irreversible. Inbound payments after closure go to a suspense ledger. See [Close an Account](../virtual-accounts/close) for details.
